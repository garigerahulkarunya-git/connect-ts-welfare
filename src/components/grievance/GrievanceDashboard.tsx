...
import { sampleGrievances, grievanceDistrictStats, districts } from "@/data/mockData";
...
const GrievanceDashboard = () => {
  ...
  const pieData = [
    { name: "Success", value: resolvedG },
    { name: "Pending Review", value: pendingG },
  ];
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <Select>
              ...
              <SelectContent>
                ...
                <SelectItem value="scholarship">Post-Matric Scholarship</SelectItem>
                <SelectItem value="driver">Driver Empowerment</SelectItem>
              </SelectContent>
            </Select>
            <Select>
        ...
        <Card className="lg:col-span-2 bg-primary text-primary-foreground">
          ...
          <CardContent className="flex flex-col items-center pt-0">
            ...
            <div className="w-full space-y-2 mt-2 text-sm">
              <div className="flex justify-between"><span className="text-green-300 font-semibold">Success</span><span className="font-bold">9,820</span></div>
              <div className="flex justify-between"><span className="opacity-70 font-semibold">Pending Review</span><span className="font-bold">1,400</span></div>
            </div>
          </CardContent>
        </Card>
      </div>
