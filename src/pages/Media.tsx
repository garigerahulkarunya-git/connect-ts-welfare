...
const sidebarLinks = [
  { label: "News Feed", icon: Newspaper, active: true },
  { label: "Upcoming Events", icon: Calendar },
  { label: "Success Stories", icon: Star },
  { label: "Media Gallery", icon: Image },
];
            ...
            <Card className="bg-muted/40 shadow-none">
              <CardContent className="p-8 md:flex items-center gap-8">
                ...
                <div className="flex gap-2 shrink-0">
                  <Input placeholder="Your email address" className="w-56 bg-background" />
